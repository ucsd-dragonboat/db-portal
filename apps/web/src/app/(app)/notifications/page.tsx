...
export default async function NotificationsPage() {
  const { org, userId, isAdmin, profile } = await requireOrg();
  ...
  return (
    <div className="space-y-4">
      ...
      <NotificationPrefsForm prefs={data as NotificationPrefs | null} isAdmin={isAdmin} accountEmail={profile.email} />
    </div>
  );
}
